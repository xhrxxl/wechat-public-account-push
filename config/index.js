export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6e8491cd6206c8ad",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c959cf3155b9517679c2d0e697fd3142",
   ...
   */
  USERS: [orHfa6f0HXiNN7VcYeTXGegiBP_0
    {
      // 想要发送的人的名字
      name: "露露",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "tONWGHnKlNAiMgeKSv5KwfegdIOnjYlD08hclJJTjhY",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "鄠邑区",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-09-12"},
        // 结婚纪念日
